...
# ======================================================
# NEW ROUTE: HEALTH CHECK (For Pings & UI Status)
# ======================================================
@app.route('/health', methods=['GET'])
def health_check():
    """Lightweight endpoint that returns minimal bytes to keep container alive."""
    return jsonify({
        "status": "online", 
        "cached_faces": len(known_embeddings)
    }), 200
...
if __name__ == "__main__":
    # Hugging Face Spaces strictly routes traffic via port 7860
